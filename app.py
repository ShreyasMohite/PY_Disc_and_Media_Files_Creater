...
class File:
    def __init__(self,root):
        self.root=root
        self.root.title("Disc and media file File Extention")
        self.root.geometry("500x400")
        self.root.iconbitmap("logo956.ico")
...
#======================================================================================#
        ...
        def clear():
            ...
            filextention.set("Disc and media file File Extention")
        ...
        def genrate():
            try:
                if path.get()!="":
                    ...
                    if filextention.get()!="Disc and media File Extention":
                        if filename.get()!="":

                            if filextention.get()=="Binary disc image" and filename.get()!="":
                                touch.touch(a+"/{}.bin".format(filename.get()))
                            
                            if filextention.get()=="macOS X disk image" and filename.get()!="":
                                touch.touch(a+"/{}.dmg".format(filename.get()))
                        

                            if filextention.get()=="ISO disc image" and filename.get()!="":
                                touch.touch(a+"/{}.iso".format(filename.get()))
                            

                            if filextention.get()=="Toast disc image" and filename.get()!="":
                                touch.touch(a+"/{}.toast".format(filename.get()))
                        
                            if filextention.get()=="Virtual CD" and filename.get()!="":
                                touch.touch(a+"/{}.vcd".format(filename.get()))
...
#======================================================================================#
        ...
        fileselect=["Binary disc image","macOS X disk image","ISO disc image","Toast disc image"\
                   ,"Virtual CD"]
        fileselect_combo=Combobox(firstframe,values=fileselect,font=('arial',12),width=25,state="readonly",textvariable=filextention)
        fileselect_combo.set("Disc and media File Extention")
